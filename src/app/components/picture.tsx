export default function Picture() {
    return (
        ...
        <p className="flex text-base  text-gray-400 py-5 leading-loose"> I am a junior at the University of Michigan majoring in 
        ...
        I am currently seeking 2024 SWE/Ai Summer internships. On the side from school, I am focused on devolping products for a digital identity verification platform, Soul
        </p>
        </div>
