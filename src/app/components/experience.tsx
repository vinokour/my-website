export default function Experience() {
  return (
    <div className="flex flex-col gap-y-6 h-full py-6 font-mono text-3xl md:text-4xl lg:text-5xl text-blue-400 mt-10 text-center items-center bg-slate-800 px-4 md:px-0">
